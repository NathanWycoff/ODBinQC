...
#' @param How many times to evaluate the cost function along a 1D grid? Unfortunately, the cost surface for this function is so gross that the built in numerical optimization methods fail, so a manual evaluation over a grid is necessary.
